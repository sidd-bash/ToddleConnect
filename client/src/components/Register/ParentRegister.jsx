            ...
            <div className='d-flex flex-column col-lg-6 col-12 justify-content-center'>
                <div className='mt-3 pt-5 w-75'>
                    ...
                    <p className='text-secondary mx-1 d-flex align-items-center' onClick={()=>{navigate('/teacherLogin')}}><IoArrowBackCircleOutline />
                        <div className='mx-1'>Family account</div></p>
                    <h2 className='fw-bold mx-1'>Create your Toddle account</h2>
                    <p>View and celebrate your child's learning moments, communicate with teachers and receive school updates, all from your Toddle account</p>
                    ...
                    <small>Already have an account? <a href="/parentLogin" style={{ textDecoration: "none" }}>Sign in</a></small>
                </div>
            </div>
        </div>
    )
